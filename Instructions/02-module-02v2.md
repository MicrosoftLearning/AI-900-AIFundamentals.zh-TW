...
您可以建立電腦視覺資源或**Azure AI 服務**資源，以使用**電腦視覺**服務。
...
1. 別擔心程式碼太多，重要的是它需要端點 URL 和 Azure AI 服務資源的其中一個金鑰。 從 Azure 入口網站資源的 [金鑰和端點] 頁面複製上述資訊，並貼到程式碼編輯器中，分別取代 **YOUR_KEY** 和 **YOUR_ENDPOINT** 預留位置值。
