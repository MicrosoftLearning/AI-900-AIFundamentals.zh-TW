...
Microsoft *Azure AI 服務* 包含 *語言* 服務中的文字分析功能，可提供一些現用 NLP 功能，包括文字中關鍵字組的識別，以及根據情感分類文字。
...
1. 等候部署完成。 然後移至您的 Azure AI 服務資源，然後在 [ **概觀** ] 頁面上，選取管理服務金鑰的連結。 您需要端點和金鑰，才能從用戶端應用程式連線到您的 Azure AI 服務資源。
