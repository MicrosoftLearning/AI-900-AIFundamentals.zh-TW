...
1. 按一下頁面頂端的 [部署]****。 對話框會詢問您是否要部署專案。 選取**部署**。
...
5. 選取 **[下一步：Web 應用程式>** 以繼續更新設定。 
    ...
    - **應用程式設定**
        ...
        > **注意** 若要瀏覽至您的語言資源金鑰，請開啟 [https://portal.azure.com](https://portal.azure.com?azure-portal=true) 。 在首頁上，按兩下 *[資源群組* ]，然後找出您建立語言資源的資源群組。 選取您的語言資源，然後流覽至其左側功能表。 然後選取 [金鑰] 和 [ *端點*]。 複製其中一個金鑰。 
